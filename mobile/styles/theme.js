...
export const SIZES = {
  ...
  // font sizes
  title: Math.round(width / 12),
  h1: Math.round(width / 13),
  h2: Math.round(width / 15),
  h3: Math.round(width / 17),
  h4: Math.round(width / 20),
  body1: Math.round(width / 18),
  body2: Math.round(width / 19),
  body3: Math.round(width / 22),
  body4: Math.round(width / 24),
  body5: Math.round(width / 26),
  arab1: Math.round(width / 9),
  arab2: Math.round(width / 10),
  arab3: Math.round(width / 12),
  arab4: Math.round(width / 13),
  arab5: Math.round(width / 14),
